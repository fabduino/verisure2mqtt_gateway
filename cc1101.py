...
class CC1101:
    ...
    def __init__(self):
        self.miso = Pin(19)
        self.ss = Pin(5, mode=Pin.OUT)
        self.ready = Pin(4, mode=Pin.IN)		#GDO0 not used
        self.deselect()
        self.spi = SPI(1, baudrate=500000, polarity=0, phase=0, bits=8, firstbit=SPI.MSB, sck=18, mosi=23, miso=19)
        self.reset()
